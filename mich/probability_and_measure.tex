...
\begin{eg}\leavevmode
    \begin{itemize}
        \item Take an i.i.d.\ space $(X_n)_{n \geq 1}$ of \hyperlink{def:rv}{random variables} such that $\forall T \geq 0$, $\Prob(X_1 < 1) < 1$.
...
\hypertarget{def:mean}For $X$ a \hyperlink{def:rv}{random variable}, $\mathbb{E}(X)$ is called the mean, and $\mathbb{E}((X - \mathbb{E}X)^2)$ is the variance of $X$.
...
\subsection{Type of convergence of random variables}
