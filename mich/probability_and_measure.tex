...
\begin{proof}
    ...
    \end{align*}
    \begin{align*}
        \text{independence } &\iff \forall x_i \in \R, \quad \Prob(\forall i \l X_i \leq x) = \prod_{i=1}^n \Prob(X_i \leq x_i) \\
...
\begin{lem}[1st Borel-Cantelli lemma]
...
\begin{lem}[2nd Borel-Cantelli lemma]
...
\begin{theroem}[Jensen's inequality]
