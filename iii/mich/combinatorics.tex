...
But, the best set actually grows like
\begin{center}
  \begin{tikzpicture}[scale=2]
    \def\x{1.3}
    \begin{scope}
...
\begin{defi}[Down compression]
  \hypertarget{def:downcomp}For $A \subset \mathcal{P}(X)$ $i$-\named{down-compression} of $A$ (for $1 \leq i \leq n$) is defined as follows:
