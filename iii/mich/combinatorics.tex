...
\begin{proof}
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \draw [thin, decorate, decoration={random steps,segment length=1.5pt,amplitude=0.7pt}, bred, fill=bred!20] (0.7, 1.1) circle [x radius=0.6cm, y radius=0.45cm];
      \node [left, bred] at (0.1, 1.1) {$\Gamma(\mathcal{B})$};

      \draw (0, -1) circle [x radius=1.2cm, y radius=0.6cm];
      \node [right] at (1.2, -1) {$X^{(r)}$};
      \draw [thin, decorate, decoration={random steps,segment length=1.5pt,amplitude=0.7pt}, bred, fill=bred!20] (0.6, -0.9) circle [x radius=0.3cm, y radius=0.25cm];
...
\begin{center}
  \begin{tikzpicture}
    ...
    \draw [thin, decorate, decoration={random steps,segment length=1.5pt,amplitude=0.7pt}, bgreen, fill=bgreen!20] (0.7, 1.1) circle [x radius=0.5cm, y radius=0.4cm];
    \node [left, bgreen] at (0.2, 1.1) {$A$};

    \draw (0, -1) circle [x radius=1.2cm, y radius=0.6cm];
    \node [right] at (1.2, -1) {$X^{(r-1)}$};
    \draw [thin, decorate, decoration={random steps,segment length=1.5pt,amplitude=0.7pt}, bgreen, fill=bgreen!20] (0.6, -1) circle [x radius=0.4cm, y radius=0.3cm];
