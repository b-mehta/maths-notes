...
\begin{ndef}[Kleisli category]\label{def:5.5}
  ...
  \begin{equation*}
    ...
    \end{tikzcd}
  \end{equation*}
  commutes (left square is \hyperlink{def:nattrans}{naturality} of $\mu$, right square commutes by \eqref{eq:monad3}): the upper way round is $\green{(hg)f}$ and the lower is $\green{h(gf)}$.
