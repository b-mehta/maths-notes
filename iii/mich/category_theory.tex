...
\begin{proof}
  ...
  (i) $\Rightarrow$ (ii): take $\mathscr{C}$ the \hyperlink{def:fulls}{full subcategory} of $\mathscr{E}$ on the separating set and consider $\mathscr{E} \overset{Y}\to [\mathscr{E}^{\text{op}}, \mathbf{Set}] \to [\mathscr{C}^{\text{op}}, \mathbf{Set}]$.
