...
\begin{thm}[Hahn-Banach]\hypertarget{thm:hb}
    ...
    \begin{enumerate}[label=(\roman*)]
        ...
        \item Let $A$ be an open convex non-empty in $E$ and $B$ convex non-empty in $E$ with $A \cap B = \emptyset$.
            ...
            \end{align*}
            for some $\alpha \in \R$.
        \item Take $A$ closed convex non-empty $\subset E$, $B$ a compact convex non-empty $\subset E$ with $A\cap B= \emptyset$.
            Then $\exists F: E \to \R$ linear continuous such that
            \begin{align*}
...
\begin{defi}[Initial topologies]\hypertarget{def:initTop}
...
\begin{defi}\hypertarget{def:dualSpace}
    ...
    \begin{equation*}
        F: E \to \R
    \end{equation*}
    The \textbf{weak topology} on $E'$, denoted $\sigma(E, E')$ is the \hyperlink{def:initTop}{initial topology} for the family of functions $E'$.
\end{defi}
